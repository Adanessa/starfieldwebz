...
SECRET_KEY = 'django-insecure-#5p(h+ood6#0r1c5e&f7d-g@ic^3p9&70=g1l5a!c+65i*k*c+'
...
WSGI_APPLICATION = 'starfieldwebz.wsgi.application'
...
STATICFILES_DIRS = [
    ...
    os.path.join(BASE_DIR, 'weapons/static/weapons/images'),
